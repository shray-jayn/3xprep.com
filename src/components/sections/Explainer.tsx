...
const features = [
  {
    ...
    description:
      "Every question explained by expert tutors with step-by-step breakdowns",
  },
  {
    icon: BookOpen,
    title: "Comprehensive Written Solutions",
    description:
      "Detailed written explanations you can reference anytime, anywhere",
  },
  {
    icon: BarChart3,
    title: "Adaptive Practice Drills",
    description:
      "AI-powered drills that adjust to your performance and target weak spots",
  },
  {
    icon: CheckCircle,
    title: "Performance Analytics",
    description:
      "Deep insights into your progress with actionable improvement recommendations",
  },
];
              ...
              <div className="bg-white rounded-2xl shadow-elegant p-6 lg:p-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Video Player Mockup */}
                    <div className="relative rounded-lg aspect-video flex items-center justify-center bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--navy-deep))]">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <div className="space-y-6">
              <h2 className="text-display text-fluid-headline font-bold text-primary">
                ...
                <span className="highlight-gold">Explained.</span>
              </h2>
              <p className="text-lg text-neutral-600 font-body leading-relaxed">
                3X Prep covers all exams with crystal-clear videos,
                comprehensive written explanations, adaptive practice drills,
                and detailed performance analytics. Never wonder "why" again.
              </p>
            </div>
