      ...
      <div className="container max-w-screen-xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-600 font-body max-w-3xl mx-auto leading-relaxed">
            Three pathways to academic excellence. One platform that delivers results beyond your expectations.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 mb-12">
          {pillars.map((pillar, index) => {
            ...
            return (
              <div key={index} className="card-elegant p-8 text-center group cursor-pointer">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-200 mb-6 group-hover:scale-110 transition-transform duration-200`}>
                ...
                <Button variant="ghost" className="group-hover:text-accent transition-colors" asChild>
                  <Link to={pillar.link}>
                    Learn More
