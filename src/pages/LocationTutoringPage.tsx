...
import { LocationListSkeleton } from "@/components/skeletons"
...
const LocationTutoringPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero */}
        <section className="pt-24 pb-16 lg:pt-32 lg:pb-24 bg-gradient-to-br from-background via-neutral-100/50 to-background relative overflow-hidden">
          {/* Premium Background Elements */}
          <div className="absolute inset-0 bg-gradient-to-br from-navy-deep/5 via-transparent to-primary/5"></div>
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-radial from-secondary/10 to-transparent rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-radial from-accent/10 to-transparent rounded-full blur-3xl"></div>
          
          <div className="container max-w-screen-xl mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-display text-fluid-display font-bold text-primary mb-6 leading-tight">
                3X Prep of <span className="highlight-gold">{location.city}</span>
              </h1>
              <p className="text-xl text-neutral-600 font-body mb-8 leading-relaxed">
                Elite 1-on-1 tutoring for SAT, LSAT, and MCAT. Personalized study plans designed to triple your prep—and your results.
              </p>
              <Button variant="secondary" size="lg" onClick={() => setIsLeadDialogOpen(true)}>
          ...
          <div className="container max-w-screen-xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-12">
              {packages.map((pkg, index) => (
                <div key={index} className={`card-elegant p-6 text-center relative ${pkg.popular ? 'ring-2 ring-accent ring-opacity-50 scale-105' : ''}`}>
                  {pkg.popular && (
                  ...
                  <Button variant={pkg.popular ? "default" : "outline"} className="w-full" onClick={() => setIsLeadDialogOpen(true)}>
                    Purchase
                  </Button>
                </div>
              ))}
...
export default LocationTutoringPage